...
@dp.message_handler(Command("get_income_categories"))
@dp.message_handler(text="Мои категории доходов")
async def get_income_categories(message: types.Message):
...
cb = CallbackData("delete_income_category", "id")
